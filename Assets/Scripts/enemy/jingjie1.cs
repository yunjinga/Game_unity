...
public class jingjie1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (transform.GetComponent<enemy>().waring > 0 && transform.GetComponent<enemy>().waring < 20&&isShow==true)
        {
        ...
        if (transform.GetComponent<enemy>().waring > 20&&isShow==true&& transform.GetComponent<enemy>().waring <40)
        {
            jingjie_1.gameObject.SetActive(false);
        ...
        //if (transform.GetComponent<enemy>().waring == 0)
        //{
        //    jingjie_1.gameObject.SetActive(false);
        //    jingjie_2.gameObject.SetActive(false);
        //    //isShow = false;
