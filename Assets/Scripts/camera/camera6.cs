...
public class camera6 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        cvam_1 = GameObject.Find("CM vcam12").gameObject.GetComponent<CinemachineVirtualCamera>();
        ...
        cvam_4 = GameObject.Find("CM vcam3").gameObject.GetComponent<CinemachineVirtualCamera>();
        cvam_5= GameObject.Find("CM vcam11").gameObject.GetComponent<CinemachineVirtualCamera>();
